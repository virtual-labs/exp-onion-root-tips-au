    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            queue.loadManifest([{
                ...
                id: "small_controller_arrow_largright",
                src: "././images/small_controller_arrow_larg.svg",
                type: createjs.LoadQueue.IMAGE
            }, {
                id: "small_controller_arrow_largleft",
                src: "././images/small_controller_arrow_larg.svg",
                type: createjs.LoadQueue.IMAGE
            }, {
                ...
                id: "smallcontrollerArrow_LeftBtm",
                src: "././images/small_controller_arrow_larg.svg",
                type: createjs.LoadQueue.IMAGE
            }, {
            ...
            function handleComplete() { /**handle complete function  */
                ...
                loadImages(queue.getResult("small_controller_arrow_largright"), "small_controller_arrow_largright", 472, 565, "", 0, binocular_controls_container);
                loadImages(queue.getResult("small_controller_arrow_largleft"), "small_controller_arrow_largleft", 437, 579, "", 180, binocular_controls_container);
                ...
                loadImages(queue.getResult("smallcontrollerArrow_LeftBtm"), "smallcontrollerArrow_LeftBtm", 440, 640, "", 180, binocular_controls_container);
                ...
                function microscope_bottom_switch_on_off(down_switch_on_aplha,down_switch_off_apha){
                ...
                light_microscope_container.getChildByName("down_switch_off").on("pressup", function(evt) {
                    microscope_bottom_switch_on_off(1,0);/** passing the alpha value of corresponding objects. */
                });
                
				/**Microscope bottom switch off  function */
                light_microscope_container.getChildByName("down_switch_on").on("pressup", function(evt) {
                    microscope_bottom_switch_on_off(0,1);/** passing the alpha value of corresponding objects. */
                });
				...
				binocular_controls_container.getChildByName("binocular_rectangle_one").on("pressup", function(evt) {/** Binocular light Intensity-up Arrow functionality  */
                    ...
                    if (alpha_count_white.toFixed(1) == 0) {
                        intensity_flag = true
                    }
                    /** Stop the click functionality of up arrow*/
                    if (alpha_count_white.toFixed(1) == 1.0) {
                ...
                binocular_controls_container.getChildByName("binocular_rectangle_two").on("pressup", function(evt) {
                    ...
                    if (alpha_count_white.toFixed(1) == -0.9) {
            ...
            /** This help array shows the hints for this experiment */
				...
				scope.heading = _("Mitosis in Onion Root Tips");
				...
				scope.selectSamplePlaceholder = _("Onion Root Tips");
				...
				scope.selectsampleArray = [{optionsSample: _('Onion Root Tips'),type: 0}, {optionsSample: _('Gram negative rods'),type: 1}, {optionsSample: _('Gram positive cocci'),type: 2}, {optionsSample: _('Gram positive rods'),type: 3}, {optionsSample: _('Gram negative cocci'),type: 4}, {optionsSample: _('Bacillus Subtilis (rods)'),type: 5}, {optionsSample: _('Staphylococcus aurcus ( coccus)'),type: 6}, {optionsSample: _('Onion Cell'),type: 7}, {optionsSample: _('Cheek Cell'),type: 8}, {optionsSample: _('Unstained Onion epidermal cell'),type: 9}];
				scope.$apply();
            }
        }
    }
